...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-[260px] min-h-0 flex-none flex-col overflow-hidden border-r border-border/70 bg-surface px-2.5 pb-2.5 max-[840px]:hidden">
            ...
            props.editingId === session.id ? (
              ...
              >
                <button
                  ...
                  className="min-w-0 flex-1 truncate py-1.5 text-left text-[13px] text-foreground/90"
                >
